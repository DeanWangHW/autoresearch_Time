...
**Requirements:** Apple Silicon Mac (M1/M2/M3/M4 with Metal/MPS support) or a single NVIDIA GPU, Python 3.10+, and Conda or Miniconda.
...
Activate the `autoresearch` conda environment, then spin up your Claude/Codex or whatever you want in this repo (and disable all permissions). You can prompt something like:
